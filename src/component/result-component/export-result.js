...
export function ExportResult( {resultName, onExportFinished} ){
    ...
    async function exportResult( ipcName ){
        ...
        if(ipcName=="export-staaris"){
            ...
            var newResultObject = tranformKeys(constants.resultObject, constants.template );
    ...
    return(
        ...
        <div className='d-flex flex-column mb-2'>
            <label className='dialogTitle' >Export Result</label>
        </div>

        <HLine />
        
            <div  className={style.tabPane}>
            <div className={style.active} >Export Result as</div>
            </div>
